...
class FineTunePipeline:
    ...
    def setup_mlflow(self) -> None:
        ...
        try:
            ...
            print(
                f"--- ✅ MLflow setup complete. Experiment: {self.mlflow_config.experiment_name}, Run: {self.run_name} ---"
            )
    ...
    def start_mlflow_run(self) -> None:
        ...
        try:
            ...
            print(
                f"--- ✅ MLflow run started with id: {self.run_id} and name: {self.run_name} ---"
            )
            ...
            with mlflow.start_run(nested=True, run_name=run_name):
                ...
                if training_stats:
                    ...
                    if hasattr(training_stats, "training_loss"):
                        mlflow.log_metric(
                            "final_training_loss", training_stats.training_loss
                        )
                    ...
                    if hasattr(training_stats, "global_step"):
                        mlflow.log_metric(
                            "total_training_steps", training_stats.global_step
                        )
                ...
                print(
                    f"--- ✅ Finetuning completed in {finetuning_duration:.2f} seconds ---"
                )
    ...
    def run_inference(self) -> Dict[str, Any]:
        ...
        try:
            ...
            with mlflow.start_run(nested=True, run_name=run_name):
                ...
                print(
                    f"--- ✅ Inference completed in {inference_duration:.2f} seconds ---"
                )
    ...
    def run_evaluation(self) -> Dict[str, Any]:
        ...
        try:
            ...
            with mlflow.start_run(nested=True, run_name=run_name):
                ...
                mlflow.log_metric(
                    "evaluation_duration_minutes", evaluation_duration / 60
                )
                ...
                print(
                    f"--- ✅ Evaluation completed in {evaluation_duration:.2f} seconds ---"
                )
    ...
    def stop_mlflow_run(self) -> None:
        ...
        try:
            ...
            results_summary = {
                "finetuning": self.pipeline_results.get("finetuning", {}).get(
                    "status", "not_run"
                ),
                "inference": self.pipeline_results.get("inference", {}).get(
                    "status", "not_run"
                ),
                "evaluation": self.pipeline_results.get("evaluation", {}).get(
                    "status", "not_run"
                ),
    ...
    def run_pipeline(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.enable_finetuning:
                ...
                self.pipeline_results["finetuning"] = {
                    "status": "skipped",
                    "reason": "disabled",
                }
...
def main():
    ...
    parser.add_argument(
        "--skip-inference", action="store_true", help="Skip the inference phase"
    )
    parser.add_argument(
        "--skip-evaluation", action="store_true", help="Skip the evaluation phase"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--hf-key", type=str, required=True, help="Hugging Face API token"
    )
    parser.add_argument(
        "--openai-key",
        type=str,
